...
globalkeys = mytable.join(
	...
	awful.key({ modkey }, "l", function()
		os.execute("i3lock -i machine_arald.png -Mk --bar-indicator --bar-base-width 1 --bar-max-height 1")
	...
	-- Menu
	--[[awful.key({ modkey, }, "m", function() awful.util.mymainmenu:show() end,
	...
	end, { description = "open app menu", group = "client" }),
